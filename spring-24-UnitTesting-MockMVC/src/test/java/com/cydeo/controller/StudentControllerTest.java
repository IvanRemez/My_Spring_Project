...
public class StudentControllerTest {
    ...
    @MockBean       // @Mock cannot mock Interface - only direct Objects (Implementation)
    ...
    void jsonAssert_Test() throws Exception {
        ...
        JSONAssert.assertEquals(expected, actual, true);
            // strict: true -> expected and actual must be the EXACT SAME = pass
            // strict: false -> if actual CONTAINS same data as expected = pass
    }

    @Test
    void getStudents_Test() throws Exception {

    // Creating stub (Behavior for our Mock Object - StudentService Obj.)
